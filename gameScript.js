...
// 				if((x==0 || y==0 || x==7 || y == 7)&&isPossibleAI(x, y)>0){
// 					console.log("corners");	
// 					if(x==0&&y==0){
// 						makeMove(x,y);
// 						world = new  World(path ,{"-": empty, "X":black, "0": white },  whiteArray, blackArray,);
...
// 						var vect;
// 						for(y = 1;y<7;y++){
// 							if(isPossibleAI(0,y)>max){
// 								max = isPossibleAI(0,y);
// 								vect = new Vector(0,y); 
// 							}
// 							if(isPossibleAI(7,y)>max){
// 								max = isPossibleAI(7,y);
// 								vect = new Vector(7,y); 
// 							}
// 						}
// 						for(x = 1;x<7;x++){
// 							if(isPossibleAI(x,0)>max){
// 								max = isPossibleAI(x,0);
// 								vect = new Vector(x,0); 
// 							}
// 							if(isPossibleAI(x,7)>max){
// 								console.log("this");
